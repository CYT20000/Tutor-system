...
INSERT INTO "new_Lesson" ("content", "createdAt", "endTime", "homework", "id", "nextExamScope", "note", "startTime", "studentId", "tags", "tutorId", "updatedAt") SELECT "content", "createdAt", "endTime", "homework", "id", "nextExamScope", "note", "startTime", "studentId", "tags", "tutorId", "updatedAt" FROM "Lesson";
DROP TABLE "Lesson";
